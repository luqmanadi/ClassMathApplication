...
class ListGradeMateriAdapter: ListAdapter<DataItemGrade, ListGradeMateriAdapter.MyViewHolder>(
    DIFF_CALLBACK
) {
    class MyViewHolder(private val binding: ItemListRiwayatFavoritBinding) :
